...
// TODO: improve all of the error stuff (is missing in owned.rs, very out of order and messy
//  elsewhere)
...
pub mod helpers {
    ...
    use core::{
        alloc::Layout, error::Error, marker::PhantomData, mem::forget, num::NonZeroUsize,
